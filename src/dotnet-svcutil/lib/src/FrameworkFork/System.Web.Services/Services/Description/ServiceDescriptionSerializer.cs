...
namespace System.Web.Services.Description
{
    internal class ServiceDescriptionSerializationWriter : System.Xml.Serialization.XmlSerializationWriter
    {
                ...
                if (a != null)
                {
                    for (int ia = 0; ia < ((System.Collections.ICollection)a).Count; ia++)
                    {
                        global::System.Object ai = (global::System.Object)a[ia];
                        {
                            ...
                            {
                                Write97_MimeTextBinding(@"text", @"http://System.com/wsdl/mime/textMatching/", ((global::System.Web.Services.Description.MimeTextBinding)ai), false, false);
                            }
        ...
        private void Write97_MimeTextBinding(string n, string ns, global::System.Web.Services.Description.MimeTextBinding o, bool isNullable, bool needType)
        {
            ...
            WriteStartElement(n, ns, o, false, null);
            if (needType) WriteXsiType(@"MimeTextBinding", @"http://System.com/wsdl/mime/textMatching/");
            if (((global::System.Boolean)o.@Required) != false)
            {
                WriteAttribute(@"required", @"http://schemas.xmlsoap.org/wsdl/", System.Xml.XmlConvert.ToString((global::System.Boolean)((global::System.Boolean)o.@Required)));
            }
            {
                ...
                if (a != null)
                {
                    for (int ia = 0; ia < ((System.Collections.ICollection)a).Count; ia++)
                    {
                        Write96_MimeTextMatch(@"match", @"http://System.com/wsdl/mime/textMatching/", ((global::System.Web.Services.Description.MimeTextMatch)a[ia]), false, false);
                    }
                }
            }
            WriteEndElement(o);
        ...
        private void Write96_MimeTextMatch(string n, string ns, global::System.Web.Services.Description.MimeTextMatch o, bool isNullable, bool needType)
        {
            ...
            WriteStartElement(n, ns, o, false, null);
            if (needType) WriteXsiType(@"MimeTextMatch", @"http://System.com/wsdl/mime/textMatching/");
            WriteAttribute(@"name", @"", ((global::System.String)o.@Name));
    ...
    internal class ServiceDescriptionSerializationReader : System.Xml.Serialization.XmlSerializationReader
    {
        ...
        private global::System.Web.Services.Description.OutputBinding Read111_OutputBinding(bool isNullable, bool checkType)
        {
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement && Reader.NodeType != System.Xml.XmlNodeType.None)
            {
                ...
                {
                    UnknownNode((object)o, @"http://schemas.xmlsoap.org/wsdl/:documentation, http://schemas.xmlsoap.org/wsdl/mime/:content, http://schemas.xmlsoap.org/wsdl/mime/:mimeXml, http://schemas.xmlsoap.org/wsdl/mime/:multipartRelated, http://System.com/wsdl/mime/textMatching/:text, http://schemas.xmlsoap.org/wsdl/soap/:body, http://schemas.xmlsoap.org/wsdl/soap/:header, http://schemas.xmlsoap.org/wsdl/soap12/:body, http://schemas.xmlsoap.org/wsdl/soap12/:header");
                }
                Reader.MoveToContent();
        ...
        private global::System.Web.Services.Description.MimeTextBinding Read97_MimeTextBinding(bool isNullable, bool checkType)
        {
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement && Reader.NodeType != System.Xml.XmlNodeType.None)
            {
                if (Reader.NodeType == System.Xml.XmlNodeType.Element)
                {
                    ...
                    {
                        UnknownNode((object)o, @"http://System.com/wsdl/mime/textMatching/:match");
                    }
                }
                else
                {
        ...
        private global::System.Web.Services.Description.MimePart Read103_MimePart(bool isNullable, bool checkType)
        {
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement && Reader.NodeType != System.Xml.XmlNodeType.None)
            {
                ...
                {
                    UnknownNode((object)o, @"http://schemas.xmlsoap.org/wsdl/mime/:content, http://schemas.xmlsoap.org/wsdl/mime/:mimeXml, http://System.com/wsdl/mime/textMatching/:text, http://schemas.xmlsoap.org/wsdl/soap/:body, http://schemas.xmlsoap.org/wsdl/soap12/:body");
                }
                Reader.MoveToContent();
        ...
        private global::System.Web.Services.Description.InputBinding Read110_InputBinding(bool isNullable, bool checkType)
        {
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement && Reader.NodeType != System.Xml.XmlNodeType.None)
            {
                ...
                {
                    UnknownNode((object)o, @"http://schemas.xmlsoap.org/wsdl/:documentation, http://schemas.xmlsoap.org/wsdl/http/:urlEncoded, http://schemas.xmlsoap.org/wsdl/http/:urlReplacement, http://schemas.xmlsoap.org/wsdl/mime/:content, http://schemas.xmlsoap.org/wsdl/mime/:mimeXml, http://schemas.xmlsoap.org/wsdl/mime/:multipartRelated, http://System.com/wsdl/mime/textMatching/:text, http://schemas.xmlsoap.org/wsdl/soap/:body, http://schemas.xmlsoap.org/wsdl/soap/:header, http://schemas.xmlsoap.org/wsdl/soap12/:body, http://schemas.xmlsoap.org/wsdl/soap12/:header");
                }
                Reader.MoveToContent();
        ...
        private global::System.Web.Services.Description.Types Read67_Types(bool isNullable, bool checkType)
        {
            ...
            System.Xml.Serialization.XmlSchemas a_4 = (System.Xml.Serialization.XmlSchemas)o.@Schemas;
            bool[] paramsRead = new bool[5];
            while (Reader.MoveToNextAttribute())
            {
        ...
        protected override void InitIDs()
        {
            ...
            _id45_Item = Reader.NameTable.Add(@"http://System.com/wsdl/mime/textMatching/");
