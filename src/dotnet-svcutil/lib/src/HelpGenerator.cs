        ...
        private static void WriteCodeGenerationHelp()
        {
            HelpCategory helpCategory = new HelpCategory(SR.HelpUsageCategory)
            {
                ...
                Options = new ArgumentInfo[] {
                    ...
                    ArgumentInfo.CreateFlagHelpInfo(     CommandProcessorOptions.Switches.AcceptCancellationToken.Name,                                             string.Format(SR.HelpAcceptCancellationToken, CommandProcessorOptions.Switches.AcceptCancellationToken.Abbreviation))
                }
            };
