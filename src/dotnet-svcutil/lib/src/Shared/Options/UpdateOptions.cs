...
namespace Microsoft.Tools.ServiceModel.Svcutil
{
    internal partial class UpdateOptions : ApplicationOptions
    {
        ...
        public const string AcceptCancellationTokenKey = "acceptCancellationToken";
        #endregion
        ...
        public bool? CancellationTokenParam { get { return GetValue<bool?>(AcceptCancellationTokenKey); } set { SetValue(AcceptCancellationTokenKey, value); } }
        #endregion
        ...
        public UpdateOptions()
        {
            RegisterOptions(
                ...
                new SingleValueOption<bool>(AcceptCancellationTokenKey) { SerializationName = "AcceptCancellationToken" });
        }
